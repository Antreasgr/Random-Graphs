...
def ChordalGen(n, k):
    ...
    pl.add_time("ourtotal", t_ctree + t_real_tree + t_subtrees, output=True)
...
pl.add_label('allnodes_alledges', 'Base line all nodes all edges')
